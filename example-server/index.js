...
function writeDatabaseFile(table, record) {
...
app.post("/users/create", function (req, res) {
  ...
  writeDatabaseFile("users", req.body);
...
app.post("/matrix", function (req, res) {
  ...
  res.json({
    result: resultMatrix.getDeterminante(),
  });
});

app.listen(3001, function () {
  console.log("App is running ad http://localhost:3001");
});
